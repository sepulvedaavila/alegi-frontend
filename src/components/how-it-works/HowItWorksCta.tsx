...
const HowItWorksCta = () => {
  ...
  return (
    <section id="how-it-works-cta" className="py-24 bg-gradient-to-b from-alegi-blue/5 to-white" ref={sectionRef}>
          ...
          <CardContent className="p-0">
            <div className="bg-gradient-to-r from-alegi-blue to-alegi-blue-dark text-white py-12 px-8 text-center">
              ...
              <p className="text-lg mb-8 text-white/90 max-w-lg mx-auto reveal delay-100">
                Experience the power of AI-driven legal predictions with a personalized demonstration of our platform.
              </p>
