...
const HowItWorksHero = () => {
  ...
  const handleDemoClick = () => {
    smoothScrollTo("how-it-works-cta");
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="flex flex-col justify-center md:col-span-2">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-white mb-8">
              Discover How Our System Delivers <span className="bg-gradient-to-r from-[#fcb900] to-[#fcb900] bg-clip-text text-transparent">Accurate Case Predictions.</span>
            </h1>
          </div>
          
          <div className="flex flex-col justify-center">
            <p className="text-xl text-white mb-6">
              Leverage cutting-edge AI and proprietary algorithms to gain powerful insights, reduce risk, and optimize outcomes for your legal cases.
            </p>
