...
const FaqCta = () => {
  ...
  return (
    <section id="faq-cta" className="py-24 bg-gradient-to-b from-alegi-blue/5 to-white" ref={sectionRef}>
          ...
          <CardContent className="p-0">
            <div className="bg-gradient-to-r from-[#2e1a47] to-[#5f407a] text-white py-12 px-8 text-center">
              ...
              <p className="text-lg mb-8 text-white/90 max-w-lg mx-auto reveal delay-100">
                Experience how ALEGI can transform your legal workflow with AI-powered insights, predictions, and case analysis.
              </p>
